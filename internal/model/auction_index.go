...
type AuctionIndex struct {
	...
	AuctionID       uint64        `json:"auctionId" gorm:"column:auction_id;not null;uniqueIndex:idx_contract_auction"`
	AuctionContract string        `json:"auctionContract" gorm:"column:auction_contract;size:42;not null;uniqueIndex:idx_contract_auction"`
