...
type BidIndex struct {
	...
	AuctionContract string    `json:"auctionContract" gorm:"column:auction_contract;size:42;not null"`
	...
	TxHash          string    `json:"txHash" gorm:"column:tx_hash;size:66;uniqueIndex"`
